...
<body>
    @php
        /**
         * @var InvoiceDetailResponse $venta
         */
    @endphp
                ...
                <div>
                    ...
                    <div class="row">
                        <p class="col-6 margin-b-0">
                            <strong>Punto de
                                Venta: {{ \Illuminate\Support\Str::padLeft($venta->pointOfSale, 4, '0') }}</strong>
                        </p>
                        <p class="col-6 margin-b-0">
                            <strong>Comp. Nro:
                                {{ \Illuminate\Support\Str::padLeft($venta->invoiceFrom, 9, '0') }}</strong>
                        </p>
                    </div>
                    <p><strong>Fecha de Emisión:</strong> {{ $venta->invoiceDate->format('d/m/Y') }}</p>
                    <p><strong>CUIT:</strong> {{ $venta->identification->number }}</p>
                ...
                <div class="row">
                    <p class="col-4 margin-b-0">
                        <strong>Período Facturado
                            Desde:
                        </strong>{{ $venta->periodFrom?->format('d/m/Y') ?? $venta->invoiceDate->format('d/m/Y') }}
                    </p>
                    <p class="col-3 margin-b-0">
                        <strong>Hasta:
                        </strong>{{ $venta->periodTo?->format('d/m/Y') ?? $venta->invoiceDate->format('d/m/Y') }}
                    </p>
                    <p class="col-5 margin-b-0">
                        <strong>Fecha de Vto. para el
                            pago:
                        </strong>{{ $venta->paymentDueDate?->format('d/m/Y') ?? $venta->invoiceDate->format('d/m/Y') }}
                    </p>
                </div>
            </td>
        </tr>
        <tr class="bill-row">
            <td colspan="2">
                <div>
                    <div class="row">
                        <p class="col-4 margin-b-0">
                            <strong>CUIL/CUIT: </strong>{{ $venta->buyers->first()?->identification->number ?? '-' }}
                        </p>
                    ...
                    <div class="row">
                        <p class="col-6 margin-b-0">
                            <strong>Condición Frente al IVA: </strong> {{ $venta->recipientVatCondition->getLabel() }}
                        </p>
                        <p class="col-6 margin-b-0">
                ...
                <div>
                    <div class="row text-right">
                        ...
                        <p class="col-2 margin-b-0">
                            <strong>
                                {{ Number::currency($venta->netAmount + $venta->untaxedAmount + $venta->exemptAmount, 'ars', 'es-AR') }}
                            </strong>
                        </p>
                    </div>
                    <div class="row text-right">
                        ...
                        <p class="col-2 margin-b-0">
                            <strong>
                                {{ Number::currency($venta->taxesAmount, 'ars', 'es-AR') }}
                            </strong>
                        </p>
                    </div>
                    <div class="row text-right">
                        ...
                        <p class="col-2 margin-b-0">
                            <strong>
                                {{ Number::currency($venta->totalAmount, 'ars', 'es-AR') }}
                            </strong>
                        </p>
                    </div>
                </div>
            ...
            <td>
                <div>
                    <div class="row text-right margin-b-10">
                        <strong>CAE Nº:&nbsp;</strong> {{ $venta->authorizationCode }}
                    </div>
                    <div class="row text-right">
                        <strong>Fecha de Vto. de CAE:&nbsp;</strong>
                        {{ $venta->authorizationCodeDueDate->format('d/m/Y') }}
                    </div>
                </div>
            </td>
        </tr>
